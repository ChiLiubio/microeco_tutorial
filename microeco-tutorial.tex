...
\hypersetup{
  pdftitle={Tutorial for R microeco package (v0.10.0)},
...
\title{Tutorial for R microeco package (v0.10.0)}
...
\CommentTok{\# use ggraph package method; require ggraph package}
...
The trans\_comm function can be used to transform the node classification to a new microtable object for other analysis.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# cal\_cor select NULL from v0.10.0}
\NormalTok{t1 }\OtherTok{\textless{}{-}}\NormalTok{ trans\_network}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\AttributeTok{dataset =}\NormalTok{ dataset, }\AttributeTok{cal\_cor =} \ConstantTok{NULL}\NormalTok{, }\AttributeTok{taxa\_level =} \StringTok{"OTU"}\NormalTok{, }\AttributeTok{filter\_thres =} \FloatTok{0.001}\NormalTok{)}
\CommentTok{\# require SpiecEasi package installed https://github.com/zdk123/SpiecEasi}
\CommentTok{\# please see SpiecEasi::spiec.easi for available model parameters}
...
To repeat the following code, please first install julia language in your computer and the FlashWeave package,
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# cal\_cor select NULL}
\NormalTok{t1 }\OtherTok{\textless{}{-}}\NormalTok{ trans\_network}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\AttributeTok{dataset =}\NormalTok{ dataset, }\AttributeTok{cal\_cor =} \ConstantTok{NULL}\NormalTok{, }\AttributeTok{taxa\_level =} \StringTok{"OTU"}\NormalTok{, }\AttributeTok{filter\_thres =} \DecValTok{0}\NormalTok{)}
...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Sat May 28 11:07:06 2022. Please wait...
\end{verbatim}
...
\midrule
\endhead
IW & 435 & 0.6542 & 0.3873 & 0.3642 \\
CW & 435 & 0.5626 & 0.2948 & 0.2863 \\
TW & 435 & 0.6246 & 0.4162 & 0.4 \\
\bottomrule
\end{longtable}
