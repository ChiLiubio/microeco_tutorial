...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Tue May 31 09:41:43 2022. Please wait...
\end{verbatim}
...
\midrule
\endhead
IW & 435 & 0.6537 & 0.3878 & 0.3637 \\
CW & 435 & 0.5629 & 0.2959 & 0.2865 \\
TW & 435 & 0.6246 & 0.4157 & 0.4001 \\
\bottomrule
\end{longtable}
...
\CommentTok{\# load the example dataset in microeco package as there is the rep\_fasta object in it}
\FunctionTok{load}\NormalTok{(dataset)}
\NormalTok{dataset}
