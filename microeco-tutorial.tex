...
\hypersetup{
  pdftitle={Tutorial for R microeco package (v1.9.0)},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Tutorial for R microeco package (v1.9.0)}
\author{}
\date{\vspace{-2.5em}2024-09-14}
...
The option \texttt{plot\_type\ =\ "errorbar"} in \texttt{plot\_alpha} will invoke the \texttt{data\_stat} instead of \texttt{data\_alpha} for the Mean±SE (or SD) plot (based on the ggplot2).
...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Sat Sep 14 11:08:20 2024. Please wait...
\end{verbatim}
...
\midrule()
\endhead
IW & 435 & 0.6536 & 0.3874 & 0.3637 & 9.135 \\
CW & 435 & 0.5628 & 0.2958 & 0.2864 & 14.33 \\
TW & 435 & 0.6248 & 0.416 & 0.4003 & 9.876 \\
\bottomrule()
\end{longtable}
