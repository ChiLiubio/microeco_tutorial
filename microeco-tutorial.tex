...
\hypersetup{
  pdftitle={Tutorial for R microeco package (v1.12.0)},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Tutorial for R microeco package (v1.12.0)}
\author{}
...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Wed Jan  8 09:50:30 2025. Please wait...
\end{verbatim}
...
\midrule()
\endhead
IW & 435 & 0.6539 & 0.3876 & 0.3639 & 9.125 \\
CW & 435 & 0.5629 & 0.2965 & 0.2865 & 14.31 \\
TW & 435 & 0.6245 & 0.4164 & 0.4 & 9.914 \\
\bottomrule()
\end{longtable}
...
\NormalTok{t1 }\OtherTok{\textless{}{-}}\NormalTok{ trans\_network}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\AttributeTok{dataset =}\NormalTok{ dataset, }\AttributeTok{cor\_method =} \StringTok{"bray"}\NormalTok{, }\AttributeTok{filter\_thres =} \FloatTok{0.003}\NormalTok{)}\SpecialCharTok{$}
    \FunctionTok{cal\_network}\NormalTok{(}\AttributeTok{COR\_p\_thres =} \DecValTok{0}\NormalTok{, }\AttributeTok{COR\_cut =} \FloatTok{0.3}\NormalTok{)}\SpecialCharTok{$}
    \FunctionTok{cal\_module}\NormalTok{()}\SpecialCharTok{$}
    \FunctionTok{cal\_network\_attr}\NormalTok{()}\SpecialCharTok{$}
    \FunctionTok{get\_adjacency\_matrix}\NormalTok{()}\SpecialCharTok{$}
    \FunctionTok{cal\_sum\_links}\NormalTok{()}\SpecialCharTok{$}
    \FunctionTok{save\_network}\NormalTok{(}\FunctionTok{file.path}\NormalTok{(test\_dir, }\StringTok{"network\_test\_bray\_OTU.gexf"}\NormalTok{))}\SpecialCharTok{$}
    \FunctionTok{cal\_powerlaw}\NormalTok{()}
