...
\hypersetup{
  pdftitle={Tutorial for R microeco package (v0.15.0)},
...
\title{Tutorial for R microeco package (v0.15.0)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# tab{-}delimited, i.e. map format}
...
\NormalTok{g1}
\CommentTok{\# g1 is aplot class and can be saved with aplot::ggsave or cowplot::save\_plot function}
...
Quitting from lines 999-1001 (microeco-tutorial.Rmd)
Error in \texttt{{[}.data.frame}(t1\$res\_diff, 1:5, c(1, 3:8)) : 选择了未定义的列
Calls: local \ldots{} eval\_with\_user\_handlers -\textgreater{} eval -\textgreater{} eval -\textgreater{} -\textgreater{} {[} -\textgreater{} {[}.data.frame
...
Simpson & anova & TW & a \\
Simpson & anova & CW & a \\
InvSimpson & anova & IW & a \\
InvSimpson & anova & TW & a \\
InvSimpson & anova & CW & a \\
Fisher & anova & IW & a \\
Fisher & anova & TW & a \\
Fisher & anova & CW & a \\
Coverage & anova & CW & a \\
...
The method `metagenomeSeq' and `ancombc2' depend on the metagenomeSeq package and ANCOMBC package, respectively.
...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Thu Mar 30 11:52:26 2023. Please wait...
\end{verbatim}
...
\midrule()
\endhead
IW & 435 & 0.6538 & 0.3868 & 0.3639 & 9.074 \\
CW & 435 & 0.5629 & 0.2961 & 0.2866 & 14.35 \\
TW & 435 & 0.6243 & 0.4159 & 0.3998 & 9.932 \\
\bottomrule()
\end{longtable}
...
\NormalTok{t1}\SpecialCharTok{$}\FunctionTok{plot\_scatterfit}\NormalTok{(}\AttributeTok{x =} \DecValTok{1}\NormalTok{, }\AttributeTok{y =} \DecValTok{2}\NormalTok{, }\AttributeTok{type =} \StringTok{"lm"}\NormalTok{, }\AttributeTok{lm\_equation =} \ConstantTok{FALSE}\NormalTok{)}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-295-1.pdf}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-296-1.pdf}
