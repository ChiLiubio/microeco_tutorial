...
\hypersetup{
  ...
  pdfauthor={Chi Liu, Felipe Mansoldo, Jarrod J. Scott, Alane B. Vermelho, Minjie Yao, Xiangzhen Li},
  hidelinks,
...
\author{Chi Liu, Felipe Mansoldo, Jarrod J. Scott, Alane B. Vermelho, Minjie Yao, Xiangzhen Li}
\date{2021-08-24}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-176-1.pdf}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-177-1.pdf}
...
\hypertarget{add-layers-to-plot-1}{%
\section{add layers to plot}\label{add-layers-to-plot-1}}
...
The class trans\_gamma is developed to explore the relationship between beta diversity and gamma diversity based on the study:
Zhang et al.~(2020). Local community assembly mechanisms shape soil bacterial β diversity patterns along a latitudinal gradient. Nat Commun 11, 5428 (2020);
\url{doi:10.1038/s41467-020-19228-4}.
