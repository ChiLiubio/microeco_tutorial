...
\hypersetup{
  pdftitle={Tutorial for R microeco package (v1.7.1)},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Tutorial for R microeco package (v1.7.1)}
\author{}
\date{\vspace{-2.5em}2024-06-21}
...
Since version 0.19.0, \texttt{method\ =\ \textquotesingle{}SRS\textquotesingle{}} is available for performing rarefaction by scaling with ranked subsampling \citep{Beule_normalization_2020}.
The default choice is \texttt{method\ =\ \textquotesingle{}rarefying\textquotesingle{}}.
Note that the rarefying method in microtable object is a shortcut call from the ``rarefy'' method in the \texttt{trans\_norm} class.
For other normalization methods,
please refer to the trans\_norm class help documentation and the examples in the tutorial here (\url{https://chiliubio.github.io/microeco_tutorial/other-examples-1.html\#trans_norm}).
...
\NormalTok{t1}\SpecialCharTok{$}\FunctionTok{cal\_ordination}\NormalTok{(}\AttributeTok{ordination =} \StringTok{"PCA"}\NormalTok{)}
...
\NormalTok{t1}\SpecialCharTok{$}\FunctionTok{cal\_ordination}\NormalTok{(}\AttributeTok{ordination =} \StringTok{"DCA"}\NormalTok{)}
\NormalTok{t1}\SpecialCharTok{$}\FunctionTok{plot\_ordination}\NormalTok{(}\AttributeTok{plot\_color =} \StringTok{"Group"}\NormalTok{, }\AttributeTok{loading\_arrow =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{loading\_text\_italic =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Fri Jun 21 17:01:52 2024. Please wait...
\end{verbatim}
...
\midrule()
\endhead
IW & 435 & 0.6537 & 0.3867 & 0.3638 & 9.11 \\
CW & 435 & 0.5625 & 0.2954 & 0.2862 & 14.35 \\
TW & 435 & 0.6244 & 0.4162 & 0.3999 & 9.851 \\
\bottomrule()
\end{longtable}
...
The user can also extract the result for a specified metric and perform the visualization.
