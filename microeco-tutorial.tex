...
\hypersetup{
  pdftitle={Tutorial for R microeco package (v0.11.0)},
...
\title{Tutorial for R microeco package (v0.11.0)}
...
\NormalTok{packages }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"MASS"}\NormalTok{, }\StringTok{"GUniFrac"}\NormalTok{, }\StringTok{"ggpubr"}\NormalTok{, }\StringTok{"randomForest"}\NormalTok{, }\StringTok{"ggdendro"}\NormalTok{, }\StringTok{"ggrepel"}\NormalTok{, }\StringTok{"agricolae"}\NormalTok{, }\StringTok{"picante"}\NormalTok{, }\StringTok{"pheatmap"}\NormalTok{, }\StringTok{"igraph"}\NormalTok{, }\StringTok{"rgexf"}\NormalTok{, }
    \StringTok{"ggalluvial"}\NormalTok{, }\StringTok{"ggh4x"}\NormalTok{, }\StringTok{"FSA"}\NormalTok{, }\StringTok{"gridExtra"}\NormalTok{, }\StringTok{"aplot"}\NormalTok{)}
...
\CommentTok{\# Pearson correlation using WGCNA package (https://cran.r{-}project.org/web/packages/WGCNA/index.html)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# require WGCNA package. If not installed, use install.packages("WGCNA", dependencies = TRUE)}
...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Tue Aug 30 09:45:49 2022. Please wait...
\end{verbatim}
...
\midrule
\endhead
IW & 435 & 0.654 & 0.3872 & 0.364 \\
CW & 435 & 0.5627 & 0.2952 & 0.2863 \\
TW & 435 & 0.6247 & 0.4164 & 0.4002 \\
\bottomrule
\end{longtable}
...
\NormalTok{\}}
\NormalTok{gridExtra}\SpecialCharTok{::}\FunctionTok{arrangeGrob}\NormalTok{(}\AttributeTok{grobs =}\NormalTok{ tmp, }\AttributeTok{ncol =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-276-1.pdf}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-277-1.pdf}
