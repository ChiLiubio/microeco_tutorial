...
\hypersetup{
  pdftitle={Tutorial for R microeco package (v1.15.0)},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Tutorial for R microeco package (v1.15.0)}
\author{}
...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Mon May 19 10:02:48 2025. Please wait...
\end{verbatim}
...
\midrule()
\endhead
IW & 435 & 0.5548 & 0.2903 & 0.3005 & 19.99 \\
CW & 435 & 0.5884 & 0.3137 & 0.3177 & 24.57 \\
TW & 435 & 0.5826 & 0.3604 & 0.3671 & 17.4 \\
\bottomrule()
\end{longtable}
...
\NormalTok{tmp}\SpecialCharTok{$}\NormalTok{taxa\_abund}\SpecialCharTok{$}\NormalTok{Trait }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{t}\NormalTok{(data2}\SpecialCharTok{$}\NormalTok{res\_spe\_func\_perc))}
