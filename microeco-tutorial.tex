...
\hypersetup{
  pdftitle={Tutorial for R microeco package (v1.16.0)},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Tutorial for R microeco package (v1.16.0)}
\author{}
\date{\vspace{-2.5em}2025-11-25}
...
Based on this background, we created the R microeco package \citep{Liu_microeco_2021, Liu_workflow_2025} (\url{https://github.com/ChiLiubio/microeco}).
...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Tue Nov 25 10:40:59 2025. Please wait...
\end{verbatim}
...
\midrule()
\endhead
IW & 435 & 0.5549 & 0.2907 & 0.3005 & 20.05 \\
CW & 435 & 0.5885 & 0.3136 & 0.3178 & 24.29 \\
TW & 435 & 0.5823 & 0.3595 & 0.3667 & 17.34 \\
\bottomrule()
\end{longtable}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# version \textgreater{}= 1.13.0}
\ControlFlowTok{if}\NormalTok{(}\FunctionTok{packageVersion}\NormalTok{(}\StringTok{"microeco"}\NormalTok{) }\SpecialCharTok{\textless{}} \StringTok{"1.13.0"}\NormalTok{)\{}
