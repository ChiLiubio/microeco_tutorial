...
\hypersetup{
  pdftitle={Tutorial for R microeco package (v0.8.0)},
...
\title{Tutorial for R microeco package (v0.8.0)}
...
The stored `Functions' and `Files' represent that you can access those functions or files in R6 object using \$ operator
as we show in the figure. An example is the function \texttt{dataset\$cal\_alphadiv()} and its return result \texttt{dataset\$alpha\_diversity}.
...
If you wish to see the help document of a function, you should search the name of the class it belongs to (not the name of the function)
...
\CommentTok{\# modules for the directed network}
...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Tue May 03 22:39:41 2022. Please wait...
\end{verbatim}
...
\midrule
\endhead
IW & 435 & 0.6539 & 0.387 & 0.364 \\
CW & 435 & 0.5632 & 0.2964 & 0.2867 \\
TW & 435 & 0.6247 & 0.4166 & 0.4001 \\
\bottomrule
\end{longtable}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-263-1.pdf}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-264-1.pdf}
