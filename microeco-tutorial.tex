...
\hypersetup{
  pdftitle={Tutorial for R microeco package (v0.12.0)},
...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Sun Oct 16 19:30:38 2022. Please wait...
\end{verbatim}
...
\midrule()
\endhead
IW & 435 & 0.654 & 0.3876 & 0.364 & 9.035 \\
CW & 435 & 0.5628 & 0.2961 & 0.2864 & 14.3 \\
TW & 435 & 0.6244 & 0.4155 & 0.3998 & 9.86 \\
\bottomrule()
\end{longtable}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# beem package should be first installed; see https://github.com/ChiLiubio/mecodev for installation steps}
\FunctionTok{library}\NormalTok{(mecodev)}
