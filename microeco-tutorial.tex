...
　R language and its packages ecosystem are wonderful tools for data analysis.
...
and rANOMALY\citep{Theil_rANOMALY_2021}.
However, we lack a flexible, comprehensive and modularized R package to analyze and manage the data.
We create the microeco R package\citep{Liu_microeco_2021} for this goal (\url{https://github.com/ChiLiubio/microeco}).
...
{\centering \includegraphics[width=0.8\linewidth]{microeco-tutorial_files/figure-latex/nice-fig-1} 
