...
\hypersetup{
  pdftitle={microeco: an R package for data mining in microbial community ecology},
  pdfauthor={Chi Liu, Jarrod J. Scott, Minjie Yao},
  hidelinks,
...
\author{Chi Liu, Jarrod J. Scott, Minjie Yao}
\date{2021-08-02}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# we first create an object and select PCoA for ordination}
\CommentTok{\# this operation invoke the distance matrix of bray in beta\_diversity of dataset}
\NormalTok{t1 }\OtherTok{\textless{}{-}}\NormalTok{ trans\_beta}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\AttributeTok{dataset =}\NormalTok{ dataset, }\AttributeTok{group =} \StringTok{"Group"}\NormalTok{, }\AttributeTok{measure =} \StringTok{"bray"}\NormalTok{, }\AttributeTok{ordination =} \StringTok{"PCoA"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{t1}\SpecialCharTok{$}\FunctionTok{plot\_corr}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{t1}\SpecialCharTok{$}\FunctionTok{plot\_corr}\NormalTok{(}\AttributeTok{pheatmap =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{t2}\SpecialCharTok{$}\FunctionTok{plot\_corr}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# calculate the links between or within taxonomic ranks}
\NormalTok{t1}\SpecialCharTok{$}\FunctionTok{cal\_sum\_links}\NormalTok{(}\AttributeTok{taxa\_level =} \StringTok{"Phylum"}\NormalTok{)}
\CommentTok{\# return t1$res\_sum\_links\_pos and t1$res\_sum\_links\_neg}
\CommentTok{\# require chorddiag package}
...
\NormalTok{t3}\SpecialCharTok{$}\FunctionTok{plot\_corr}\NormalTok{(}\AttributeTok{pheatmap =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
we show some examples of metagenomic data from HUMAnN and Ncyc.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# see https://github.com/ChiLiubio/file2meco and help documents for more usages}
\NormalTok{dataset}\SpecialCharTok{$}\FunctionTok{cal\_abund}\NormalTok{(}\AttributeTok{select\_cols =} \DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{, }\AttributeTok{rel =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-179-1.pdf}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-180-1.pdf}
