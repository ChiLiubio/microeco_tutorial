...
\hypersetup{
  pdftitle={Tutorial for R microeco package (v0.13.0)},
...
\NormalTok{t1}\SpecialCharTok{$}\FunctionTok{cal\_manova}\NormalTok{(}\AttributeTok{mformula =} \StringTok{"Group + Type"}\NormalTok{)}
\NormalTok{t1}\SpecialCharTok{$}\NormalTok{res\_manova}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Sun Nov 27 22:33:11 2022. Please wait...
\end{verbatim}
...
\midrule()
\endhead
IW & 435 & 0.6542 & 0.3879 & 0.3643 & 9.065 \\
CW & 435 & 0.5628 & 0.2961 & 0.2864 & 14.43 \\
TW & 435 & 0.6243 & 0.4165 & 0.3998 & 9.857 \\
\bottomrule()
\end{longtable}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-285-1.pdf}
