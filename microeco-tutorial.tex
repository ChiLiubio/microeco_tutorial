...
\hline
rcompanion & trans\_alpha class & convert asterisk signif to letters\\
\hline
...
\NormalTok{packages }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"MASS"}\NormalTok{, }\StringTok{"GUniFrac"}\NormalTok{, }\StringTok{"ggpubr"}\NormalTok{, }\StringTok{"randomForest"}\NormalTok{, }\StringTok{"ggdendro"}\NormalTok{, }\StringTok{"ggrepel"}\NormalTok{, }\StringTok{"agricolae"}\NormalTok{, }\StringTok{"picante"}\NormalTok{, }\StringTok{"pheatmap"}\NormalTok{, }\StringTok{"igraph"}\NormalTok{, }\StringTok{"rgexf"}\NormalTok{, }
    \StringTok{"ggalluvial"}\NormalTok{, }\StringTok{"ggh4x"}\NormalTok{, }\StringTok{"rcompanion"}\NormalTok{, }\StringTok{"FSA"}\NormalTok{, }\StringTok{"gridExtra"}\NormalTok{, }\StringTok{"aplot"}\NormalTok{, }\StringTok{"NST"}\NormalTok{, }\StringTok{"GGally"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{test }\OtherTok{\textless{}{-}}\NormalTok{ dataset}\SpecialCharTok{$}\FunctionTok{merge\_taxa}\NormalTok{(}\AttributeTok{taxa =} \StringTok{"Family"}\NormalTok{)}
\NormalTok{test}
\end{Highlighting}
\end{Shaded}
...
## microtable-class object:
## sample_table have 90 rows and 4 columns
## otu_table have 616 rows and 90 columns
## tax_table have 616 rows and 5 columns
\end{verbatim}
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1067}}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1467}}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1067}}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1333}}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1733}}
...
\begin{verbatim}
## Now randomizing by parallel computing. Begin at Tue Mar 21 22:12:06 2023. Please wait...
\end{verbatim}
...
\midrule()
\endhead
IW & 435 & 0.6541 & 0.3867 & 0.3641 & 9.131 \\
CW & 435 & 0.5628 & 0.2955 & 0.2864 & 14.42 \\
TW & 435 & 0.6248 & 0.4162 & 0.4003 & 9.873 \\
\bottomrule()
\end{longtable}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-291-1.pdf}
...
\includegraphics{microeco-tutorial_files/figure-latex/unnamed-chunk-292-1.pdf}
