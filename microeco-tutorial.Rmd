...
# this operation invoke the distance matrix of bray in beta_diversity of dataset
...
The function cal_sum_links() is used to sum the links (edge) number from one taxa to another or in the same taxa.
...
and add the julia in the computer path (see FlashWeave part in https://github.com/ChiLiubio/microeco).
...
<!--chapter:end:06-Other_examples.Rmd-->

# mecodev package
The mecodev package (https://github.com/ChiLiubio/mecodev/) is designed to develop more classes for the data analysis.
