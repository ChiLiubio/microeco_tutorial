--- 
title: "Tutorial for R microeco package (v0.6.5)"
...
2. install the packages in advance. We recommend this solution if you are interest in most of the methods in the microeco package and want to run a large number of examples in tutorial.
...
packages <- c("MASS", "GUniFrac", "ggpubr", "randomForest", "ggdendro", "ggrepel", "agricolae", "gridExtra", "picante", "pheatmap", "igraph", "rgexf", "ggalluvial", "ggh4x")
...
Then, we can calculate the taxa abundance at each taxonomic rank using cal_abund().
...
we can use other_taxa parameter in cal_cor function.
...
Please see https://chiliubio.github.io/microeco_tutorial/intro.html#tax4fun for installing Tax4Fun package and download SILVA123 ref data.
...
Please see https://chiliubio.github.io/microeco_tutorial/intro.html#tax4fun2 for downloading ncbi-blast and Ref99NR/Ref100NR.
...
tax4fun2_pathway <- t1$res_tax4fun2_pathway
rownames(tax4fun2_pathway) <- tax4fun2_pathway[, 1]
tax4fun2_pathway <- tax4fun2_pathway[, -1]
func_num <- ncol(tax4fun2_pathway): (ncol(tax4fun2_pathway) - 2)
func_map <- tax4fun2_pathway[, func_num]
colnames(func_map) <- c("level_1", "level_2", "level_3")
tax4fun2_pathway <- tax4fun2_pathway[, -func_num]
# create a microtable object for pathways
func2 <- microtable$new(otu_table = tax4fun2_pathway, tax_table = func_map, sample_table = use_dataset$sample_table)
func2$tidy_dataset()
func2
...
```{r, echo = TRUE, eval = FALSE}
# see https://github.com/ChiLiubio/file2meco for the installation
library(file2meco)
...
The humann2meco() function can be used to creat the microtable object using metagenomic analysis files from HUMAnN3 (https://huttenhower.sph.harvard.edu/humann). 
