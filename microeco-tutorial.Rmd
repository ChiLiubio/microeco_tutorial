--- 
title: "Tutorial for R microeco package (v0.10.0)"
...
t2$plot_network()
# use ggraph package method; require ggraph package
...
```{r, echo = TRUE, eval=FALSE}
# cal_cor select NULL from v0.10.0
t1 <- trans_network$new(dataset = dataset, cal_cor = NULL, taxa_level = "OTU", filter_thres = 0.001)
# require SpiecEasi package installed https://github.com/zdk123/SpiecEasi
# please see SpiecEasi::spiec.easi for available model parameters
...
```{r, echo = TRUE, eval=FALSE}
# cal_cor select NULL
t1 <- trans_network$new(dataset = dataset, cal_cor = NULL, taxa_level = "OTU", filter_thres = 0)
