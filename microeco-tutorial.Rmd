...
Any contribution of a modified class is also appreciated through github pushing or email (liuchi0426@126.com).
...
The function plot_scatterfit() in trans_env class is designed for the scatter plot, adding the fitted line and statistics.
