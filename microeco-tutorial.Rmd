--- 
title: "Tutorial for R microeco package (v2.0.0)"
date: "`r Sys.Date()`"
...
Based on this background, we created the R microeco package [@Liu_microeco_2021; @Liu_workflow_2025].
...
sub1 <- t1$subset_network(node = mt$otu_table %>% .[.[, "S1"] != 0, ] %>% rownames, rm_single = TRUE, return_igraph = FALSE)
