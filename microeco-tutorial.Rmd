...
If the user only want to get the taxa with significant different abundance, both the method parameter "KW" and "KW_dunn" are available in trans_diff$new.
...
# see https://chiliubio.github.io/microeco_tutorial/intro.html#tax4fun2  for the reading example
data(rep_fasta_16S)
