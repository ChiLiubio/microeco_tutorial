--- 
title: "Tutorial for R microeco package (v1.3.0)"
...
description: "The tutorial for R microeco (v1.2.0), file2meco (v0.7.0), meconetcomp (v0.4.0) and mecoturn packages"
---
...
```{r, echo = TRUE, eval = FALSE}
# install file2meco package (>= 0.7.0)
