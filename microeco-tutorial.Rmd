...
```{r, echo = TRUE, eval = FALSE}
# allow more waiting time for the downloading of each package
options(timeout = 1000)
# If a package is not installed, it will be installed from CRAN
# First select the packages of interest
tmp <- c("microeco", "file2meco", "MASS", "GUniFrac", "ggpubr", "randomForest", "ggdendro", "ggrepel", "agricolae", "igraph", "picante", "pheatmap", "rgexf", 
    "ggalluvial", "ggh4x", "rcompanion", "FSA", "gridExtra", "aplot", "NST", "GGally", "ggtern", "MicrobiomeStat", "ggraph", "networkD3", "poweRlaw")
...
# allow more time for the downloading in R
...
t1$plot_bar(bar_type = "notfull", use_alluvium = TRUE, clustering = TRUE, color_values = RColorBrewer::brewer.pal(8, "Set2"))
```
...
### Key points
  ...
  + trans_diff\$new: In trans_diff\$new, p_adjust_method = "none" or NULL can close the p value adjustment. 
...
test1$plot_bar(facet = "Group") + ylab("Abundance (RPK)")
...
test1$plot_bar(facet = "Group", color_values = RColorBrewer::brewer.pal(12, "Set3")) + ylab("Abundance (RPK)")
```
