--- 
title: "Tutorial for R microeco package (v1.7.1)"
date: "`r Sys.Date()`"
...
description: "The tutorial for R microeco (v1.7.1), file2meco (v0.7.1), meconetcomp (v0.5.0) and mecoturn packages"
---
...
Since version 0.19.0, `method = 'SRS'` is available for performing rarefaction by scaling with ranked subsampling [@Beule_normalization_2020].
The default choice is `method = 'rarefying'`.
Note that the rarefying method in microtable object is a shortcut call from the "rarefy" method in the `trans_norm` class.
