--- 
title: "Tutorial for R microeco package (v0.15.0)"
...
g1
# g1 is aplot class and can be saved with aplot::ggsave or cowplot::save_plot function
...
### Key points
  ...
  + trans_diff$new: this class has a strict requirement on the taxonomic information, make sure `tidy_taxonomy()` function has been performed for the dataset$tax_table
...
For regression, `lm_equation = FALSE` can be applied to not display the regression equation.
