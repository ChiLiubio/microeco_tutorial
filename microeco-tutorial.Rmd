--- 
title: "Tutorial for R microeco package (v0.11.0)"
...
packages <- c("MASS", "GUniFrac", "ggpubr", "randomForest", "ggdendro", "ggrepel", "agricolae", "picante", "pheatmap", "igraph", "rgexf", 
    "ggalluvial", "ggh4x", "FSA", "gridExtra", "aplot")
...
# Pearson correlation using WGCNA package (https://cran.r-project.org/web/packages/WGCNA/index.html)
...
```{r, echo = TRUE, eval=FALSE}
# require WGCNA package. If not installed, use install.packages("WGCNA", dependencies = TRUE)
