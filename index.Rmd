--- 
title: "Tutorial for R microeco package (v1.16.0)"
date: "`r Sys.Date()`"
...
Based on this background, we created the R microeco package [@Liu_microeco_2021; @Liu_workflow_2025] (https://github.com/ChiLiubio/microeco).
